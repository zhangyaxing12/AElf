...
{
    public class LimitTransactionCountTestModule : AbpModule
    {
    ...
    public class TransactionGrouperLimitTransactionCountTest : AbpIntegratedTest<LimitTransactionCountTestModule>
    {
